        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl">
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">{categoryData.studentsEnrolled.toLocaleString()}</div>
              <div className="text-sm text-gray-600">Students Enrolled</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">{groupedExams.sections.reduce((total, section) => total + section.exams.length, 0)}</div>
