...
const ExamNotifications = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Enhanced Header */}
      <div className="relative py-8 bg-gradient-to-br from-primary/5 via-background to-accent/5 rounded-2xl overflow-hidden -mx-4 px-4 md:-mx-6 md:px-6">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-4">
            ...
            <Card className="bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 backdrop-blur border-emerald-500/30 hover:border-emerald-400/50 transition-colors group">
              <CardContent className="p-4 text-center">
                <div className="flex items-center justify-center mb-2">
                  <CheckCircle className="h-5 w-5 text-emerald-500 mr-2 group-hover:scale-110 transition-transform" />
                </div>
                <div className="text-2xl md:text-3xl font-bold text-emerald-500 mb-1">{stats.applicationOpen}</div>
                <div className="text-xs md:text-sm text-muted-foreground">Applications Open</div>
              </CardContent>
            </Card>
            <Card className="bg-gradient-to-br from-sky-500/10 to-sky-600/5 backdrop-blur border-sky-500/30 hover:border-sky-400/50 transition-colors group">
              <CardContent className="p-4 text-center">
                <div className="flex items-center justify-center mb-2">
                  <Clock className="h-5 w-5 text-sky-500 mr-2 group-hover:scale-110 transition-transform" />
                </div>
                <div className="text-2xl md:text-3xl font-bold text-sky-500 mb-1">{stats.upcoming}</div>
            ...
            <Card className="bg-gradient-to-br from-amber-500/10 to-amber-600/5 backdrop-blur border-amber-500/30 hover:border-amber-400/50 transition-colors group">
              <CardContent className="p-4 text-center">
                <div className="flex items-center justify-center mb-2">
                  <CheckCircle className="h-5 w-5 text-amber-500 mr-2 group-hover:scale-110 transition-transform" />
                </div>
                <div className="text-2xl md:text-3xl font-bold text-amber-500 mb-1">{stats.newNotifications}</div>
                <div className="text-xs md:text-sm text-muted-foreground">Results Out</div>
              </CardContent>
            </Card>
          </div>
      ...
      {/* Filters Section */}
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between py-4 border-y border-border/50">
        {/* Search */}
