...
const WelcomeBanner = ({ name, targetExam = 'IBPS PO', performanceLevel = 45 }: WelcomeBannerProps) => {
  const levelInfo = getLevelInfo(performanceLevel);
  
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-sm p-6 md:p-8 border border-gray-100">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className={`bg-gradient-to-r ${levelInfo.color} text-white px-4 py-1 rounded-full text-sm font-semibold flex items-center gap-1.5 shadow-md`}>
          ...
          <div className="flex flex-wrap gap-2 items-center">
            <div className="bg-blue-50 text-blue-700 text-sm py-1.5 px-4 rounded-full font-medium border border-blue-200">
              🎯 Target: {targetExam}
            </div>
        ...
        <div className="flex items-center gap-3">
          <div className="text-right mr-2">
            <div className="w-24 h-24 rounded-full border-4 border-gray-200 flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50">
              <img 
