        ...
        <div className="flex-1">
          ...
          {user && (
            <div className="mt-4 flex flex-wrap gap-2">
              {user.examCategory && (
                <div className="bg-green-50 text-green-700 text-sm py-1 px-3 rounded-full">
                  <span className="font-medium">{getExamCategoryName(user.examCategory)}</span>
                </div>
              )}
              
              {user.state && (
                <div className="bg-orange-50 text-orange-700 text-sm py-1 px-3 rounded-full flex items-center">
